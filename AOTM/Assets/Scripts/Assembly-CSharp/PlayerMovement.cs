...
public class PlayerMovement : MonoBehaviour
{
	...
	private void Update()
	{
		running = ControlFreak2.CF2Input.GetButton("Run");
		MouseMove();
		PlayerMove();
		StaminaUpdate();
	}
	...
	private void MouseMove()
	{
		...
		rotation.eulerAngles += new Vector3(0f, ControlFreak2.CF2Input.GetAxis("Mouse X") * mouseSensitivity * Time.deltaTime * Time.timeScale, 0f);
	...
	private void PlayerMove()
	{
		...
		Vector3 vector = base.transform.right * ControlFreak2.CF2Input.GetAxis("Strafe");
		Vector3 vector2 = base.transform.forward * ControlFreak2.CF2Input.GetAxis("Forward");
