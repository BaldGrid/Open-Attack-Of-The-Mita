    ...
    public class FlyingCamera : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (isRotating)
            {
                ...
                float rotationX = transform.localEulerAngles.y + ControlFreak2.CF2Input.GetAxis("Mouse X") * mouseSensitivity;
                rotationY += ControlFreak2.CF2Input.GetAxis("Mouse Y") * mouseSensitivity;
