        ...
        void FixedUpdate()
        {
            ...
            else
            {
                if (ControlFreak2.CF2Input.GetButton("Fire2"))
                {
                    ...
                    float inputH = ControlFreak2.CF2Input.GetAxis("Mouse X"); //Input.mousePosition.x;
                    float inputV = ControlFreak2.CF2Input.GetAxis("Mouse Y"); //Input.mousePosition.y;
                ...
                if (ControlFreak2.CF2Input.GetKey(KeyCode.W) || ControlFreak2.CF2Input.GetKey(KeyCode.UpArrow)) inputdir.z = movingSensitivity;
                if (ControlFreak2.CF2Input.GetKey(KeyCode.S) || ControlFreak2.CF2Input.GetKey(KeyCode.DownArrow)) inputdir.z = -movingSensitivity;
                if (ControlFreak2.CF2Input.GetKey(KeyCode.A) || ControlFreak2.CF2Input.GetKey(KeyCode.LeftArrow)) inputdir.x = -movingSensitivity;
                if (ControlFreak2.CF2Input.GetKey(KeyCode.D) || ControlFreak2.CF2Input.GetKey(KeyCode.RightArrow)) inputdir.x = movingSensitivity;
