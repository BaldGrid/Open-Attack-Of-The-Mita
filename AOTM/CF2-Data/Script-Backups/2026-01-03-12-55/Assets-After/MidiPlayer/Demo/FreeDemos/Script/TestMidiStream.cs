...
namespace DemoMPTK
{
    public class TestMidiStream : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha1 + key))
                {
                ...
                if (eventsMidi[key] != null && ControlFreak2.CF2Input.GetKeyUp(KeyCode.Alpha1 + key))
                {
            ...
            // -----------------------------
            if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.DownArrow) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.UpArrow))
            {
                if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.DownArrow)) CurrentPreset--;
                if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.UpArrow)) CurrentPreset++;
